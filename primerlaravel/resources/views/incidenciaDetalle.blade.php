...
<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Latitud: {{ $incidencia ->latitud }} - Longitud {{ $incidencia->longitud}}</h5>
<p class="font-normal text-gray-700 dark:text-gray-400">Ciudad: {{ $incidencia->ciudad }}</p>
<p class="font-normal text-gray-700 dark:text-gray-400">Direccion: {{ $incidencia->direccion }}</p>
<p class="font-normal text-gray-700 dark:text-gray-400">Estado: {{ $incidencia->estado }}</p>
</a>
